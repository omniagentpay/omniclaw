...
const gates = [
  { label: "Budget Gate", color: "primary", x: 170, description: "Spending limits" },
  { label: "Rate Gate", color: "accent", x: 305, description: "Frequency control" },
  { label: "Recipient Gate", color: "primary", x: 440, description: "Allowlist check" },
  { label: "SingleTx Gate", color: "accent", x: 575, description: "Amount per tx" },
  { label: "Confirm Gate", color: "primary", x: 710, description: "HITL approval" },
];
      ...
      <div className="container mx-auto max-w-6xl">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Every transaction passes through five atomic guard checks before execution.
            </p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.15}>
          <div className="glass-card p-8 md:p-12 max-w-4xl mx-auto">
            <svg viewBox="0 0 900 200" className="w-full" fill="none">
              <line x1="40" y1="100" x2="860" y2="100" stroke="hsl(220 15% 20%)" strokeWidth="2" />
              <line x1="40" y1="100" x2="860" y2="100" stroke="url(#flowGradient)" strokeWidth="2" strokeDasharray="8 12" className="animate-path-flow" style={{ strokeDashoffset: 0 }} />
              ...
              {gates.map((gate, i) => {
                ...
                return (
                  <g key={gate.label}>
                    ...
                    <text x={gate.x} y={96} textAnchor="middle" fill={isActive ? (gate.color === "primary" ? "hsl(75 100% 50%)" : "hsl(190 100% 50%)") : "hsl(210 20% 75%)"} fontSize="10" fontWeight="600" fontFamily="Inter" className="transition-all duration-500">{gate.label}</text>
              ...
              <circle cx="860" cy="100" r="8" fill="hsl(190 100% 50%)" opacity="0.8" />
              <text x="860" y="140" textAnchor="middle" fill="hsl(215 12% 50%)" fontSize="11" fontFamily="Inter">Execute</text>
              <defs>
