...
const tabs = [
  {
    ...
    code: [
      ...
      { token: "module", text: "omniclaw.adapters" },
      { token: "keyword", text: " import " },
      { token: "type", text: "TransferAdapter" },
      { token: "plain", text: "\n\n" },
      { token: "variable", text: "adapter" },
      { token: "plain", text: " = " },
      { token: "type", text: "TransferAdapter" },
      { token: "plain", text: "(\n  " },
      { token: "param", text: "network" },
      { token: "plain", text: "=" },
      { token: "string", text: '"base"' },
      { token: "plain", text: ",\n  " },
      { token: "param", text: "token" },
      { token: "plain", text: "=" },
      { token: "string", text: '"USDC"' },
      { token: "plain", text: "\n)\n" },
      { token: "variable", text: "tx" },
      { token: "plain", text: " = adapter." },
      { token: "function", text: "send" },
      { token: "plain", text: "(\n  " },
      { token: "param", text: "to" },
      { token: "plain", text: "=" },
      { token: "string", text: '"0x7f3a...c9e1"' },
      { token: "plain", text: ",\n  " },
      { token: "param", text: "amount" },
      { token: "plain", text: "=" },
      { token: "number", text: "0.50" },
      { token: "plain", text: "\n)" },
    ],
    stats: [
      { label: "Latency", value: "<400ms" },
      { label: "Fee", value: "0.01%" },
      { label: "Chains", value: "Base, Polygon, Arb" },
    ],
  },
  {
    id: "x402",
    ...
    code: [
      ...
      { token: "module", text: "omniclaw.adapters" },
      { token: "keyword", text: " import " },
      { token: "type", text: "X402Adapter" },
      { token: "plain", text: "\n\n" },
      { token: "variable", text: "x402" },
      { token: "plain", text: " = " },
      { token: "type", text: "X402Adapter" },
      { token: "plain", text: "(\n  " },
      { token: "param", text: "wallet" },
      { token: "plain", text: "=" },
      { token: "variable", text: "agent_wallet" },
      { token: "plain", text: "\n)\n\n" },
      { token: "comment", text: "# Auto-pays on HTTP 402 response" },
      { token: "plain", text: "\n" },
      { token: "variable", text: "response" },
      { token: "plain", text: " = x402." },
      { token: "function", text: "fetch" },
      { token: "plain", text: "(\n  " },
      { token: "string", text: '"https://api.vendor.ai/generate"' },
      { token: "plain", text: ",\n  " },
      { token: "param", text: "max_cost" },
      { token: "plain", text: "=" },
      { token: "number", text: "0.003" },
      { token: "plain", text: "\n)" },
    ],
    stats: [
      { label: "Protocol", value: "HTTP 402" },
      { label: "Min Payment", value: "$0.0001" },
      { label: "Standard", value: "x402 v1.2" },
    ],
  },
  {
    id: "gateway",
    ...
    code: [
      ...
      { token: "module", text: "omniclaw.adapters" },
      { token: "keyword", text: " import " },
      { token: "type", text: "GatewayAdapter" },
      { token: "plain", text: "\n\n" },
      { token: "variable", text: "gw" },
      { token: "plain", text: " = " },
      { token: "type", text: "GatewayAdapter" },
      { token: "plain", text: "(\n  " },
      { token: "param", text: "source" },
      { token: "plain", text: "=" },
      { token: "string", text: '"ethereum"' },
      { token: "plain", text: ",\n  " },
      { token: "param", text: "destination" },
      { token: "plain", text: "=" },
      { token: "string", text: '"base"' },
      { token: "plain", text: "\n)\n" },
      { token: "variable", text: "bridge_tx" },
      { token: "plain", text: " = gw." },
      { token: "function", text: "bridge" },
      { token: "plain", text: "(\n  " },
      { token: "param", text: "amount" },
      { token: "plain", text: "=" },
      { token: "number", text: "100.00" },
      { token: "plain", text: ",\n  " },
      { token: "param", text: "recipient" },
      { token: "plain", text: "=" },
      { token: "string", text: '"0xab12...ef56"' },
      { token: "plain", text: "\n)" },
    ],
    stats: [
      { label: "Bridge Time", value: "~90s" },
      { label: "Protocol", value: "CCTP v2" },
      { label: "Chains", value: "8 supported" },
    ],
  },
];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            Swap payment protocols with a single config change. No rewrite required.
          </p>
        </div>
            ...
            return (
              <button
                ...
                className={`flex-1 flex items-center gap-3 px-5 py-4 rounded-lg border transition-all duration-300 text-left ${
                  isActive
                    ? "border-primary/40 bg-primary/5 border-glow-lime"
            ...
            <div className="terminal-bg p-5">
              <pre className="font-mono text-sm leading-relaxed whitespace-pre-wrap">
                {active.code.map((segment, i) => (
                  <span key={i} className={tokenColors[segment.token] || "text-foreground"}>
                    {segment.text}
                  </span>
                ))}
              </pre>
